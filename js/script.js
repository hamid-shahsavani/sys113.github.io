...
// ----------------------------- hide owl carusel prev and next button with hover download list button -----------------------

$(".download-list").hover(
  function (e) {
    $(".owl-next").hide();
    $(".owl-prev").hide();
    $("#owl-carousel-category").trigger('stop.owl.autoplay');
  }, function () {
    $(".owl-next").show();
    $(".owl-prev").show();
    $("#owl-carousel-category").trigger('play.owl.autoplay');
  }
);
...
$(".image-tool").click(function () {
  var owlc = $("#owl-carousel-category");
  $("#owl-carousel-category").trigger('stop.owl.autoplay');
  let get_img_src = $(this).children("img").attr("src");
  $("body").append("<div class='image-tool-lightbox' style='background-image: url(" + get_img_src + ")'></div>");
  $("body").css('overflow', 'hidden');

  $(".image-tool-lightbox").click(function () {
    $(this).remove();
    $("body").css("overflow", "visible");
    $("#owl-carousel-category").trigger('play.owl.autoplay');
  });
